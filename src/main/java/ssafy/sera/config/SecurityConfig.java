...
import ssafy.sera.common.exception.handler.CustomAccessDeniedHandler;
import ssafy.sera.common.exception.handler.CustomAuthenticationEntryPoint;
import ssafy.sera.common.properties.CorsProperties;
import ssafy.sera.config.filter.JwtAuthenticationFilter;

import static ssafy.sera.common.constant.security.AUTHENTICATED_PATH.AUTHENTICATED_ONLY;
